let {CancelOrderRunningByOrderID} = require('../model/db.js');
let moment = require('moment');

module.exports = async (req, res) => {
  try {
    if ( req.user && (req.user.level < 3)) {
      let {id_order_running_cancel,note} = req.body;
      ...
      await CancelOrderRunningByOrderID(id_order_running_cancel,4,1,date_finish,note);
